...
const text = `╭──────•◈•──────╮\n│𝗨𝘀𝗲 ${prefix}help [Name?]\n│𝗨𝘀𝗲 ${prefix}help [Page?]\n│𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 : │ Ullash ッ\n│𝗧𝗢𝗧𝗔𝗟 : [${arrayInfo.length}]\n│📛🄿🄰🄶🄴📛 :  [${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}]\n╰──────•◈•──────╯`; 
    var link = [
"https://imgur.com/a/DkEKjSb", "https://imgur.com/a/DkEKjSb", "https://imgur.com/a/DkEKjSb", "https://imgur.com/a/DkEKjSb",
"https://imgur.com/a/DkEKjSb",
"https://imgur.com/a/DkEKjSb",
"https://imgur.com/a/DkEKjSb",
    ]
     var callback = () => api.sendMessage({ body: siu + "\n\n" + msg  + text, attachment: fs.createReadStream(__dirname + "/cache/loidbutter.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/Screenshot_20250527-230625.jpg"), event.messageID);
